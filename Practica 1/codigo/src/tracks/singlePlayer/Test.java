...
public class Test {
    ...
    public static void main(String[] args) {
		...
		/*COMENTADA POR MI*/ //ArcadeMachine.playOneGame(game, level1, recordActionsFile, seed);

		// 2. This plays a game in a level by the controller.
		/*DESCOMENTADA POR MI*/ //ArcadeMachine.runOneGame(game, level1, visuals, controlador, recordActionsFile, seed, 0);
...
//		}
		...
		ArcadeMachine.runGames(game, levels, M, controlador, saveActions? actionFiles:null);
